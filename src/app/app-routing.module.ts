...
// import { VolunteerCreateComponent } from './volunteers/volunteers-create/volunteers-create.component';
...
const routes: Routes = [
	...
	// { path: 'volunteers/create', component: VolunteerCreateComponent, canActivate: [AuthGuard]  },
	// { path: 'volunteers/view', component: VolunteersViewComponent, canActivate: [AuthGuard]  },
	// { path: 'volunteers/edit/:volID', component: VolunteerCreateComponent, canActivate: [AuthGuard]  },
